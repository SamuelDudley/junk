...
#****************************************************************************
    ...
    def __init__(self, u8Instance, sNetInterface):
        ...
        self.sCameraURL = None
        while self.sCameraURL == None:
...
#****************************************************************************
    ...
    def __sFindCameraURL(self, sInterface):
        ...
        try:
            ...
            print("error fetching camera details")
            return None
...
#****************************************************************************
    ...
    def getImgSize(self):
        sResponse = self.__sSimpleCall("getStillSize")#"getSupportedExposureMode")
        print sResponse
...
if __name__ == "__main__":
    sc_SonyQX1_0 = SmartCamera_SonyQX(0,'wlan0')
    #sc_SonyQX1_0.main()
    sc_SonyQX1_0.imgSize()
    sc_SonyQX1_0.getImgSize()
    sc_SonyQX1_0.setImgSize()
    #sc_SonyQX1_0.main()